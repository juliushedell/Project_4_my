...
<style scoped>
.pollOption input[type="radio"].pollOptionButtons {
  opacity: 0.01;
  z-index: 1000;
}

.pollOption input[type="radio"].pollOptionButtons:checked + label {
  background: yellow;
}

.pollOption input[type="radio"].pollOptionButtons:hover + label {
  background: yellow
}

.pollOption label.pollOptionButtons {
